...
dpdf2$theta2 <- theta2
dpdf2$theta3 <- theta3
dpdf2$pop <- ((1/resolution1)**2)*100000
dpdf2$lambda1 <- theta1*((1/resolution1)**2)*100000
dpdf2$lambda2 <- theta2*((1/resolution1)**2)*100000
dpdf2$lambda3 <- theta3*((1/resolution1)**2)*100000
dpdf2$e1 <- ((1/resolution1)**2)*sum(dpdf2$lambda1)
dpdf2$e2 <- ((1/resolution1)**2)*sum(dpdf2$lambda2)
dpdf2$e3 <- ((1/resolution1)**2)*sum(dpdf2$lambda3)
...
voronoi_sf$pop <- round(st_area(voronoi_sf)*100000,0)
